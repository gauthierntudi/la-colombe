...
type ReceiveStockModalProps = {
  open: boolean;
  onClose: () => void;
  onSubmit: (data: { productId: string; quantity: string; reason: string }) => Promise<void>;
  products: Product[];
  siteLabel?: string;
  loading?: boolean;
  error?: string;
...
const defaultForm = { productId: "", quantity: "", reason: "Réception stock" };
...
export function ReceiveStockModal({
  ...
  return (
    <Modal
      ...
      description={
        siteLabel
          ? `Ajouter des unités au site « ${siteLabel} ».`
      ...
      footer={
        <div className="flex gap-3 justify-end w-full">
          ...
          <button type="submit" form="receive-stock-form" className="btn btn-primary" disabled={loading}>
